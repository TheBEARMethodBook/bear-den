...
export const BEAR_ACTIONS = [
  ...
  },
  {
    ...
    why_it_works:
      "A call with literally nothing to ask for is rare enough now to register as care rather than a transaction. The absence of an agenda is the entire message — it's what proves the outreach was about them, not you.",
  ...
  },
  {
    ...
    theme: 'ENGAGE',
    action:
      "Notice something someone is doing well — at work, as a parent, in how they're handling something hard — and tell them specifically what you noticed, today.",
    why_it_works:
  ...
  },
  {
    ...
    theme: 'AUTHENTIC',
    action:
      "Tell someone something you got wrong recently — a mistake, a misjudgment, a moment you handled badly — without minimizing it or turning it into a joke.",
    why_it_works:
  ...
  },
  {
    ...
    theme: 'AUTHENTIC',
    action:
      'Ask someone, "Is there anything I can do that would actually be useful to you right now?" — and mean it literally, not rhetorically.',
    why_it_works:
  ...
  },
  {
    ...
    theme: 'AUTHENTIC',
    action:
      "Say the thing you've been avoiding saying to someone — a boundary, an apology, a piece of feedback — in person or by call, not text.",
    why_it_works:
  ...
  },
  {
    ...
    theme: 'AUTHENTIC',
    action:
      'Find one loop you left open with someone — a promise, a "let\'s circle back," a question you never answered — and close it today.',
    why_it_works:
  ...
  },
  {
    ...
    theme: 'AUTHENTIC',
    action:
      "Tell someone the truth about something you've been politely agreeing with but don't actually believe — kindly, but plainly.",
    why_it_works:
  ...
  },
  {
    ...
    theme: 'RESTORE',
    action:
      'Reconnect with someone by referencing something good from your shared history, not the reason you drifted: "I still think about [specific memory] — you\'ve been on my mind."',
    why_it_works:
  ...
  },
  {
    ...
    theme: 'RESTORE',
    action:
      'Send a restoration message with one low-stakes, specific ask attached — coffee on a particular day, a 10-minute call — instead of a vague "we should catch up sometime."',
    why_it_works:
