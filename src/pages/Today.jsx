...
export default function Today() {
  ...
  return (
    <div className="flex min-h-screen flex-col" style={{ backgroundColor: '#FAF6EE' }}>
      <header
        className="flex items-center justify-between px-5 py-4"
        style={{ backgroundColor: '#1B2A4A' }}
      >
        <span className="text-xl font-bold tracking-tight" style={{ color: '#C9A227' }}>
          The BEAR Den
        </span>
        <div
        ...
        >
          ...
          <div className="mt-5 flex flex-col gap-3 sm:flex-row">
            <button
              ...
              disabled={actionDone}
              className="flex-1 rounded-full py-3 text-sm font-bold uppercase tracking-wide shadow-md transition-opacity disabled:opacity-60"
            ...
            <button
              type="button"
              className="flex-1 rounded-full border py-3 text-sm font-semibold uppercase tracking-wide"
